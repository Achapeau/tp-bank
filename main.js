...
readline.question(
  "Voulez-vous avoir un découvert (o/n) ? ",
  function (isOverdraft) {
    ...
    function askOverdraftAmount() {
      readline.question(
        "Entrez le montant du découvert autorisé entre 100 et 2000 €: ",
        function (amount) {
    ...
    function askInitialDeposit() {
      readline.question(
        "Entrez le montant à transférer pour l'ouverture du compte (minimum de 500 €): ",
        function (deposit) {
